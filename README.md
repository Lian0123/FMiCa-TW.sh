...
* lolcat :  一個彩虹配色的cat指令
    * license ： [WTFPL](https://zh.wikipedia.org/wiki/WTFPL)
...
* conky-all :  
    * license ： [GPL3](https://zh.wikipedia.org/wiki/GNU通用公共许可证#GPLv3) / [BSD授權](https://zh.wikipedia.org/wiki/BSD%E8%AE%B8%E5%8F%AF%E8%AF%81)
